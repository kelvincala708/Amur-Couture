    ...
    <div className="min-h-screen bg-amur-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-serif text-amur-black mb-2">Welcome Back</h1>
          <p className="text-amur-gray">Sign in to your Amur Couture account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-amur-champagne hover:text-amur-gray transition-colors">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-amur-gray">New to Amur Couture?</span>
              </div>
            </div>
